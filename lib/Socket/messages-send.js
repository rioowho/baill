...
if ((0, WABinary_1.isJidGroup)(jid) || (0, WABinary_1.isJidUser)(jid)) {
    ...
    } else if (message?.carouselMessage && Array.isArray(message.carouselMessage.items)) {
        stanza.content.push({
            tag: 'biz',
            attrs: {},
            content: [
                    ...
                    content: [
                        {
                            tag: 'carousel',
                            attrs: {},
                            content: message.carouselMessage.items.map(item => ({
                                tag: 'carousel_item',
                                attrs: { id: item.id },
                                content: [
                                    { tag: 'title', content: item.title },
                                    { tag: 'description', content: item.description || '' },
                                    {
                                        tag: 'buttons',
                                        content: Array.isArray(item.buttons) ? item.buttons.map(button => ({
                                            tag: 'button',
                                            attrs: { id: button.id },
                                            content: [{ tag: 'title', content: button.title }]
                                        })) : []
                                    }
                                ]
                            }))
    ...
    } else if (message?.listMessage && Array.isArray(message.listMessage.sections)) {
        stanza.content.push({
            tag: 'biz',
            attrs: {},
            content: [
                    ...
                    content: [
                        {
                            ...
                            attrs: {},
                            content: [
                                { tag: 'title', content: message.listMessage.title || '' },
                                { tag: 'description', content: message.listMessage.description || '' },
                                {
                                    tag: 'sections',
                                    content: message.listMessage.sections.map(section => ({
                                        tag: 'section',
                                        attrs: { title: section.title },
                                        content: Array.isArray(section.items) ? section.items.map(item => ({
                                            tag: 'option',
                                            attrs: { id: item.id },
                                            content: [{ tag: 'title', content: item.title }]
                                        })) : []
                                    }))
                                }
                            ]
